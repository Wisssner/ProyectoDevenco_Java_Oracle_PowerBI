...
import Modelo.DAO.ExternoPartida_MezclaDAO;
import Modelo.ExternoPartida;
import Modelo.Partida;
import Modelo.ExternoPartida_Mezcla;
import Vistas.V_ExternoPartida_Mezcla;
...
public class ExternoC_Partida_Mezcla implements ItemListener,ActionListener, KeyListener, MouseListener{
    ExternoPartida_MezclaDAO pmDAO = new ExternoPartida_MezclaDAO();
    V_ExternoPartida_Mezcla vpm = new V_ExternoPartida_Mezcla();
    ...
    public ExternoC_Partida_Mezcla(V_ExternoPartida_Mezcla vpm){
        this.vpm=vpm;
        this.vpm.btt_Actualizar_I1.addActionListener(this);
        ...
        this.vpm.btt_Actualizar_E1.addActionListener(this);
    ...
    public void init(){
     ...
     public void initListarPartidas(){
        ...
        List<ExternoPartida_Mezcla> listaParIP = new ExternoPartida_MezclaDAO().listarCodPartida_Mezcla(varCodCiaGlobalDeLogin,"I");
        List<ExternoPartida_Mezcla> listaParEP = new ExternoPartida_MezclaDAO().listarCodPartida_Mezcla(varCodCiaGlobalDeLogin,"E");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==vpm.btt_Actualizar_I1){
            actualizarDatos("I");
            actualizarTabla();
        }
        ...
        if(e.getSource()==vpm.btt_Actualizar_E1){
            actualizarDatos("E");
            actualizarTabla();
        }
    ...
    public void initTablaPartidaMezcla_I(){
        List<ExternoPartida_Mezcla> listaI = new ExternoPartida_MezclaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"I");
    ...
    public void initTablaPartidaMezcla_E(){
        List<ExternoPartida_Mezcla> listaE = new ExternoPartida_MezclaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"E");
    ...
    public void mouseClicked(MouseEvent e) {
       ...
       if(e.getSource()==vpm.tablaPartida_Mezcla_I){
            ...
            ExternoPartida_Mezcla pmI = new ExternoPartida_MezclaDAO().listarId(varCodCiaGlobalDeLogin,"I",cod,cor);
       ...
       if(e.getSource()==vpm.tablaPartida_Mezcla_E){
            ...
            ExternoPartida_Mezcla pmE = new ExternoPartida_MezclaDAO().listarId(varCodCiaGlobalDeLogin,"E",cod,cor);
    ...
    public void registrarDatos(String tip){
        ExternoPartida_Mezcla pm = new ExternoPartida_Mezcla();
        char vig;
        if(tip == "I"){
        ...
        if(tip == "I"){
            ...
            if(fila!=-1){
                ...
                if(pmDAO.busOrden(varCodCiaGlobalDeLogin,tip,pad,pm.getNivel(),pm.getOrden())==true){
                    ExternoPartida_Mezcla pmI =new ExternoPartida_MezclaDAO().listarOrden(varCodCiaGlobalDeLogin,"I",pad,pm.getNivel(),pm.getOrden());
                    pmI.setOrden(ordenI);
            ...
            if(fila!=-1){
                ...
                pm.setVigente(vig);
                if(pmDAO.busOrden(varCodCiaGlobalDeLogin,tip,pad,pm.getNivel(),pm.getOrden())==true){
                    ExternoPartida_Mezcla pmE =new ExternoPartida_MezclaDAO().listarOrden(varCodCiaGlobalDeLogin,"E",pad,pm.getNivel(),pm.getOrden());
                    pmE.setOrden(ordenE);
    ...
    public void eliminarDatos(String tip){
        ...
        if(tip=="I"){
            ...
            if(fila!=-1){
                ...
                cor = Integer.parseInt(vpm.tablaPartida_Mezcla_I.getValueAt(fila,0).toString());
                cod = Integer.parseInt(vpm.tablaPartida_Mezcla_I.getValueAt(fila,1).toString());
                new ExternoPartida_MezclaDAO().eliminarDatos(varCodCiaGlobalDeLogin,cod,tip,cor);
            }else{
                showMessage1("Debe seleccionar una fila");
            }
        }
    ...
    public void vaciarCampos(){
        ...
        codPAD = Integer.parseInt(vpm.padCodPartida_I.getSelectedItem().toString());
            if(codPAD==0){
                ...
                vpm.orden_I.setValue(new ExternoPartida_MezclaDAO().asignarOrden("I",1,varCodCiaGlobalDeLogin));
        ...
        codPAD = Integer.parseInt(vpm.padCodPartida_E.getSelectedItem().toString());
            if(codPAD==0){
                ...
                vpm.orden_E.setValue(new ExternoPartida_MezclaDAO().asignarOrden("E",1,varCodCiaGlobalDeLogin));
    ...
    public void itemStateChanged(ItemEvent e) {
       if(e.getSource()==vpm.padCodPartida_I && vpm.padCodPartida_I.getSelectedItem() != null){
            ...
            if(codPAD==0){
                ...
                vpm.nivel_I.setValue(new ExternoPartida_MezclaDAO().asignarNivelNoNULL("I", codPAD,varCodCiaGlobalDeLogin));
                vpm.orden_I.setValue(new ExternoPartida_MezclaDAO().asignarOrdenNoNULL("I", codPAD,varCodCiaGlobalDeLogin));
                vpm.nivel_I.setEnabled(false);
                vpm.orden_I.setEnabled(false);
            }
        }
       ...
       if(e.getSource()==vpm.padCodPartida_E && vpm.padCodPartida_E.getSelectedItem() != null){
            ...
            if(codPAD==0){
                ...
                vpm.nivel_E.setValue(new ExternoPartida_MezclaDAO().asignarNivelNoNULL("E", codPAD,varCodCiaGlobalDeLogin));
                vpm.orden_E.setValue(new ExternoPartida_MezclaDAO().asignarOrdenNoNULL("E", codPAD,varCodCiaGlobalDeLogin));
                vpm.nivel_E.setEnabled(false);
                vpm.orden_E.setEnabled(false);
            }
        }

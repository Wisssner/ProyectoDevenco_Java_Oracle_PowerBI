...
import Vistas.V_ExternoProy_Partida_Mezcla;
...
public class ExternoC_Proy_Partida_Mezcla implements ItemListener,ActionListener, KeyListener, MouseListener{
    
    ExternoProy_Partida_MezclaDAO ppmDAO = new ExternoProy_Partida_MezclaDAO();
    V_ExternoProy_Partida_Mezcla vppm = new V_ExternoProy_Partida_Mezcla();
    ...
    public ExternoC_Proy_Partida_Mezcla(V_ExternoProy_Partida_Mezcla vppm){
        this.vppm=vppm;
    ...
    public void initListarPartidas(int pyto){
        ...
        List<ExternoPartida_Mezcla> listaParIP = new ExternoPartida_MezclaDAO().listarMezclas(varCodCiaGlobalDeLogin,"I");
        List<ExternoPartida_Mezcla> listaParAuxIP = new ExternoPartida_MezclaDAO().listarMezclasPadre(varCodCiaGlobalDeLogin,"I");
        List<ExternoPartida_Mezcla> listaParEP = new ExternoPartida_MezclaDAO().listarMezclas(varCodCiaGlobalDeLogin,"E");
        List<ExternoPartida_Mezcla> listaParAuxEP = new ExternoPartida_MezclaDAO().listarMezclasPadre(varCodCiaGlobalDeLogin,"E");
    ...
    public void initTablaProyPartidaMezcla_I(){
        List<ExternoProy_Partida_Mezcla> listaI = new ExternoProy_Partida_MezclaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"I");
    ...
    public void initTablaProyPartidaMezcla_E(){
        List<ExternoProy_Partida_Mezcla> listaE = new ExternoProy_Partida_MezclaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"E");
    ...
    public void mouseClicked(MouseEvent e) {
       ...
       if(e.getSource()==vppm.tablaProy_Partida_Mezcla_I){
            ...
            ExternoProy_Partida_Mezcla pmI = new ExternoProy_Partida_MezclaDAO().listarId(varCodCiaGlobalDeLogin,"I",cod,cor,ver,pyto);
       ...
       if(e.getSource()==vppm.tablaProy_Partida_Mezcla_E){
            ...
            ExternoProy_Partida_Mezcla pmE = new ExternoProy_Partida_MezclaDAO().listarId(varCodCiaGlobalDeLogin,"E",cod,cor,ver,pyto);
    ...
    public void actualizarDatos(String tip){
        ...
        if(tip == "I"){
            ...
            if(fila!=-1){
                ...
                new ExternoProy_Partida_MezclaDAO().actualizar(pm);
    ...
    public void eliminarDatos(String tip){
        ...
        if(tip=="I"){
            ...
            if(fila!=-1){
                ...
                cor = Integer.parseInt(vppm.tablaProy_Partida_Mezcla_I.getValueAt(fila,2).toString());
                cod = Integer.parseInt(vppm.tablaProy_Partida_Mezcla_I.getValueAt(fila,3).toString());
                new ExternoProy_Partida_MezclaDAO().eliminarDatos(varCodCiaGlobalDeLogin,cod,tip,cor,pyto,ver);
            }else{
                showMessage1("Debe seleccionar una fila");
            }
        }

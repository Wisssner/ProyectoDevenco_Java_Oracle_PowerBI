...
public class V_ExternoDProy_Partida_Mezcla extends javax.swing.JPanel {

    public V_ExternoDProy_Partida_Mezcla() {
        initComponents();
        setOpaque(false);
        init();
    }
    ...
    private void initComponents() {
        ...
        codPartida_I.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                codPartida_IActionPerformed(evt);
            }
        });
    ...
    private void codPartida_IActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_codPartida_IActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_codPartida_IActionPerformed

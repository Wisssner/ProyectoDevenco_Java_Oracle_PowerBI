...
public class ExternoProy_Partida_Mezcla {
    private int codCia;
    private int codPyto;
    ...
    public ExternoProy_Partida_Mezcla() {
    }

    public ExternoProy_Partida_Mezcla(int codCia, int codPyto, String ingEgr, int nroVersion, int codPartida, int corr, int padCodPartida, String tUnitMed, String eUnitMed, int nivel, int orden, float costoUnit, int cant, float costoTot) {
        this.codCia = codCia;

...
public class ExternoProy_Partida{
    ...
    public ExternoProy_Partida() {
    }

    public ExternoProy_Partida(int CodCia, int codPyto, int nroVersion, String ingEgr, int CodPartida, String CodPartidas, String FlgCC, int Nivel, String uUniMed, String tabEstado, String codEstado, char Vigente) {
        this.CodCia = CodCia;

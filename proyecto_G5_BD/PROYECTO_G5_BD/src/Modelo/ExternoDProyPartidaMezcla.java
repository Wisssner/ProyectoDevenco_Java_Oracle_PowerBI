...
public class ExternoDProyPartidaMezcla {
    private int codCia;
    private int codPyto;
    ...
    public ExternoDProyPartidaMezcla() {
    }

    public ExternoDProyPartidaMezcla(int codCia, int codPyto, String ingEgr, int nroVersion, int codPartida, int corr, int sec, String tDesembolso, String eDesembolso, int nroPago, String tCompPago, String eCompPago, Date fecDesembolso, float impDesemNeto, float impDesemIgv, float impDesemTotal, int semilla, int rep) {
        this.codCia = codCia;

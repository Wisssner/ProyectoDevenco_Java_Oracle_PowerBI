...
public class ExternoPartida {
    ...
    public ExternoPartida(){
        
    }

    public ExternoPartida(int CodCia, String ingEgr, int CodPartida, String CodPartidas, String DesPartida, String FlgCC, int Nivel, String tUniMed, String eUniMed, int Semilla, char Vigente) {
        this.CodCia = CodCia;
        this.ingEgr = ingEgr;

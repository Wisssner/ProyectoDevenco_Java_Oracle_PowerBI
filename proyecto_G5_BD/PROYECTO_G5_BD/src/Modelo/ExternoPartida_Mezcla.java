...
public class ExternoPartida_Mezcla {
    private int codCia;
    ...
    public ExternoPartida_Mezcla() {
    }

    public ExternoPartida_Mezcla(int codCia, String ingEgr, int codPartida, int corr, int padCodPartida, String tUnitMed, String eUnitMed, float costoUnit, int nivel, int orden, char vigente) {
        this.codCia = codCia;
        this.ingEgr = ingEgr;
